                    ...
                    <?php foreach ($products as $product): ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <div class="flex justify-center">
                                    <img src="<?= htmlspecialchars($product['image']) ?>"
                                        class="w-24 h-24 object-cover rounded shadow" alt="Ảnh sản phẩm">
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="?act=editProduct&id=<?= $product['id'] ?>"
                                    class="text-blue-600 hover:text-blue-900 mr-3 transition-colors">Sửa</a>
                                <a href="?act=deleteProduct&id=<?= $product['id'] ?>"
